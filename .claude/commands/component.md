...
Create `tests/components/[ComponentName].test.tsx` with 2-3 simsple tests:
...
```bash
nmp test tests/components/[ComponentName].test.tsx
```
...
### 4. Run Tests (expect to pass)

```bash
nmp test tests/components/[ComponentName].test.tsx
```

Interate on component development until all tests pass
